myapp
.controller('status', function($scope,$ionicHistory,$ionicPopup,CACHE) {
})
.controller('status_temp', function($scope,$ionicPopup,$interval,$http) {
	$scope.temps={};
	gettemp=function(){
		$http.post('process/p.status.sensor.php',{'sensor':'temp'})
...
.controller('status_humi', function($scope,$ionicPopup,$interval,$http) {
	$scope.humis={};
	gethumi=function(){
		$http.post('process/p.status.sensor.php',{'sensor':'humi'})
		.then(function(result) {
